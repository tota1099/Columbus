<div class="container-fluid">
    <div class="row">
        <div class="item">
            <img src="{$smarty.const.URL_IMG}/548306.jpg" class="img-responsive img-heightFull">
        </div>
    </div>
</div>
<div class="container">
    <div class="row">
        <div class="col-lg-3 col-md-4 col-xs-12">
            <a href="#" class="thumbnail">
                <img src="{$smarty.const.URL_IMG}/548306.jpg" alt="Imagem">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
            <a href="#" class="thumbnail">
    ...
    <div class="row">
        ...
        <div class="media">
            <div class="media-left media-middle">
                <a href="#">
                    <img src="{$smarty.const.URL_IMG}/548306.jpg" alt="Imagem" style="width:64 px; height: 64px;">
                </a>
            </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 col-xs-12 col-md-12">
            ...
            <img src="{$smarty.const.URL_IMG}/548306.jpg" class="img-responsive center-block">
            <h1>Image shape</h1>
            <img src="{$smarty.const.URL_IMG}/548306.jpg" class="img-thumbnail img-responsive center-block">
        </div>
    </div>
</div>
